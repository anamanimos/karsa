...
class Business extends Model
{
    ...
    public function initializeDefaults(): void
    {
        ...
        $defaultAccounts = [
            ...
            ['code' => '3-2001', 'name' => 'Laba Ditahan / Berjalan', 'type' => 'equity', 'subtype' => 'equity', 'initial_balance' => 0],
            ...
            ['code' => '5-1001', 'name' => 'Beban Pokok Penjualan (HPP)', 'type' => 'expense', 'subtype' => 'cogs', 'initial_balance' => 0],
