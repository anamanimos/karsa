<x-app-layout>
    ...
    <div class="py-4 pb-12 space-y-4">
        ...
        <div class="glass-card p-4">
            <form action="{{ route('reports.sales') }}" method="GET" class="flex flex-col sm:flex-row sm:items-end gap-3">
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto">
                    ...
                    <a href="{{ route('reports.sales') }}" class="btn-secondary py-2 px-3 text-xs text-center">Reset</a>
                </div>
            </form>
        </div>
